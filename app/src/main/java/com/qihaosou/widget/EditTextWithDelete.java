...
public class EditTextWithDelete extends EditText implements OnFocusChangeListener{
	...
	private void init() {
		...
		//获取图片资源
		imgSearch=context.getResources().getDrawable(R.mipmap.icon_search);
		imgDelete = context.getResources().getDrawable(R.mipmap.icon_close);
	...
	private void setDrawable() {
		...
		if (length() == 0) {
			...
			setCompoundDrawablesWithIntrinsicBounds(imgSearch, null, imgDelete, null);
